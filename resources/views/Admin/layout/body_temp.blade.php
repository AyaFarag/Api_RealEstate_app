      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
             <li><a href="{{ route('moderator.index')}}">{{ trans('language.view moderator') }}</a></li>
             <li><a href="{{ route('moderator.create')}}">{{ trans('language.add moderator') }}</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
             <li><a href="{{ route('setting.index')}}">{{ trans('language.view setting') }}</a></li>
             {{--  <li><a href="{{ route('setting.create')}}">+ Add setting</a></li>  --}}
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('pages.index')}}">{{ trans('language.view pages') }}</a></li>
            {{-- <li><a href="{{ route('pages.create')}}">+ Add Pages Content</a></li> --}}
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('partner.index')}}">{{ trans('language.view partners') }}</a></li>
            <li><a href="{{ route('partner.create')}}">{{ trans('language.create partners') }}</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('country.index')}}">{{ trans('language.view countries') }}</a></li>
            <li><a href="{{ route('country.create')}}">{{ trans('language.add countries') }}</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('city.index')}}">{{ trans('language.view cities') }}</a></li>
            <li><a href="{{ route('city.create')}}">{{ trans('language.add cities') }}</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('category.index')}}">{{ trans('language.view categories') }}</a></li>
            <li><a href="{{ route('category.create')}}">{{ trans('language.add categories') }}</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('specialization.index')}}">{{ trans('language.view specialization') }}</a></li>
            <li><a href="{{ route('specialization.create')}}">{{ trans('language.add specialization') }}</a></li>
       ...
       <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="{{ route('plan.index')}}">{{ trans('language.view plans') }}</a></li>
          <li><a href="{{ route('plan.create')}}">{{ trans('language.add plans') }}</a></li>
          <li><a href="{{ url('/pendding/plan/page')}}">{{ trans('language.approve plans') }}</a></li>
          <li><a href="{{ route('plans.index')}}">{{ trans('language.assign plans') }}</a></li>

        </ul>
      </li>


        {{--  companies subscribtion   --}}
        <li class="treeview">
          <a href="#"><i class="fa fa-align-justify"></i> <span>{{ trans('language.companies') }}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ url('/pendding/company/page')}}">{{ trans('language.companies subscription') }}</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('/pendding/ads/page')}}">{{ trans('language.pendding') }}</a></li>
            {{--  <li><a href="{{ url('/approved/company/page')}}">{{ trans('language.approved') }}</a></li>
            <li><a href="{{ url('/rejected/company/page')}}">{{ trans('language.rejected') }}</a></li>  --}}
          </ul>
        </li>
