                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover" >
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{route('specialization.edit', $specialization->id)}}" class="btn btn-success">{{ trans('language.edit') }}</a> 

                          &nbsp
                          <a href="{{ route('specialization.delete', $specialization->id) }}" class="btn btn-danger">{{ trans('language.delete') }}</a>
                     </td>
