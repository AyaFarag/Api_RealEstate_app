                            ...
                            @foreach($plan as $plan)
                              <div class="col-md-4">
                                  <div class="card pb-5 px-5 m-1 packages_pgk text-center">
                                      ...
                                      <div>
                                          <a href="{{route('plan.edit', $plan->id)}}" class="btn btn-success">{{ trans('language.edit') }}</a> 

                                          &nbsp
                                          <a href="{{ route('plan.delete', $plan->id) }}" class="btn btn-danger">{{ trans('language.delete') }}</a>
