...
<div class="row" dir="rtl">
  <div class="col-md-12 " >
    <div class="box box-warning">
        ...
        <div class="box-body">
          <form method="get" action="{{ route('partner.create') }}">
        ...
        <table class="table table-hover" >
          ...
          <tbody>
            <tr>
              ...
              <td>
              	@if ($company -> partner)
                	<a href="{{ route('partner.remove', $company->id) }}" class="btn btn-danger">Remove Partner</a>
                @else
                  <a href="{{route('partner.store', $company->id)}}" class="btn btn-success">Add Partner</a>
              	@endif
              </td>
            </tr>
          </tbody>
