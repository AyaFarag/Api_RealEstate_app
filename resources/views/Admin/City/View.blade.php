                ...
                <div class="box-body">
                  <table class="table table-hover" >
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{route('city.edit', $city->id)}}" class="btn btn-success">{{ trans('language.edit') }}</a>

                          &nbsp
                          <a href="{{ route('city.delete', $city->id) }}" class="btn btn-danger">{{ trans('language.delete') }}</a>
                     </td>
