                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-body">
                                ...
                                <textarea id="" type="text" class=" form-control" name="social_network[facebook]">{{$setting->social_network['facebook']}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>   
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-body">
                                ...
                                <textarea id="" type="text" class=" form-control" name="social_network[twitter]">{{$setting->social_network['twitter']}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>   
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-body">
                                ...
                                <textarea id="" type="text" class=" form-control" name="social_network[instagram]">{{$setting->social_network['instagram']}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>   
