...
class SubscriptionController extends Controller
{
    ...
    public function PenddingPlans(Subscription $subscription)
    {
        $subscription = App\Models\Subscription::orderBy('id','desc')->get();
    ...
    public function search(Request $request){
            ...
            $subscription = Subscription::where('status', $search)->get();
            return view('Admin.Plan.Request',compact('subscription'));
    }
    ...
    public function filter(Request $request){
            $search = $_GET['search'];
            $subscription = Subscription::where('status', $search)->get();
            return view('Admin.Company.section',compact('subscription'));
    }
