	...
	public function get($key = NULL)
	{
		...
		$return =  [
          ...
          'type'=>'all',
					...
					'responses'=>[
						[
							'code'=>200,
							'data'=>['data'=>(new \App\Http\Resources\UserResource(\App\Models\Api\User::where("role", \App\Models\Api\User::COMPANY_ROLE) -> first()))->toArray(request())],
						],
						[
							'code'=>401,
							'data'=>'{"error":"Invalid email or password"}',
		...
		/************************************ Companies ********************************************/
	      ...
	      [
	          ...
	          'type'=>'company',
	          'headers'=>["Authorization" => "Bearer {token}"],
	          'url'=>'/api/companies/company-meta-data/{id}',
	          'method'=>'PUT',
	          'description'=>'Update the metadata for an existing project',
	          'parameters'=> array_merge($this->getParameters("id"), $this->postParamaeters(new \App\Http\Requests\Api\Companies\CompanyMetaDataRequest())),
	          'responses'=>[
	              [
	                  'code'=>200,
	                  'data'=>'{"message": "Updated successfully"}',
          ...
          'type'=>'company',
					...
					'method'=>'POST',
					'description'=>'Add a workday for a specific company',
					'parameters'=>$this->postParamaeters(new \App\Http\Requests\Api\Companies\WorkDaysRequest()),
					'responses'=>[
						[
							'code'=>200,
							'data'=>'{"message": "Added successfully"}',
          ...
          'type'=>'company',
					...
					'parameters'=>array_merge($this->getParameters("id"), $this->postParamaeters(new \App\Http\Requests\Api\Companies\WorkDaysRequest())),
					'responses'=>[
						[
							'code'=>200,
							'data'=>'{"message": "Updated successfully"}',
          ...
          'type'=>'all',
					...
					'responses'=>[
						[
							'code'=>200,
							'data'=>['data'=>(new \App\Http\Resources\ProjectResource(factory(\App\Models\Project::class)->make()))->toArray(request())],
						]
					]
				],
          ...
          'type'=>'all',
					...
					'responses'=>[
						[
							'code'=>200,
							'data'=>['data'=>(new \App\Http\Resources\CommentResource(factory(\App\Models\Comment::class)->make()))->toArray(request())],
						]
					]
				],
